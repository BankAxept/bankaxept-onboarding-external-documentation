...
| Bax number      | A six or seven digit number. Similiar to merchant id for Visa and Mastercard. Is connected to 1 or more payment terminals with an address, a settlement account, and a MCC. |
